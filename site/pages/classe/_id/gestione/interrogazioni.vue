...
<main>
    <div class="nav-scroller bg-white box-shadow">
      <nav class="nav nav-underline">
        ...
        <a class="nav-link active" href="../gestione/interrogazioni">Interrogazioni</a>
...
<CalendarManagerInterrogazioni :calendarEvents="calendarEvents" :classeId="classe.id"/>
</main>
</template>
...
let components = {};
if(process.browser) {
    const CalendarManagerInterrogazioni = require('~/components/CalendarManagerInterrogazioni').default;
    components = {
        CalendarManagerInterrogazioni
    }
}
